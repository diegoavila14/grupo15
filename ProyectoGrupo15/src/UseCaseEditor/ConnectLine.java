...
public class ConnectLine {
    ...
    public static final int LINE_ARROW_BASIC = 0;
    public static final int LINE_ARROW_EXTEND = 1;
    public static final int LINE_ARROW_INCLUDE = 2;
    public static final int LINE_ARROW_ISA = 3;
...
//		            g2d.drawLine(p2.x, p1.y + (p2.y - p1.y) / 2, p2.x, p2.y-Dif[1]);
            	...
            	//g2d.drawLine(p1.x, p1.y, p2.x, p2.y);
            	//paintArrow(g2d, p1, p2);//CAmbiar a triangulo
